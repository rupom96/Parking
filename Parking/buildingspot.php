                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"> 
                        ...
                        <div class="booking-form-wrapper text-center clearfix">
                            <h3 class="join-heading">Building Spot</h3>
                            ...
                            <form action="buildingspot.php" method="POST">
                            ...
                            <form class="booking-form" name="registration"> 
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="psid" class="form-control" placeholder="Building_id" type="text" name="psid">
                                    <span class="errorcolor"><?php global $PS_IdErr; echo $PS_IdErr; ?> </span>
                                </div>
                                <div class="form-group col-md-6">
								
                                    <input id="Location" class="form-control" placeholder="Location" type="text" name="Location">
                                    <span class="errorcolor"><?php global $LocationErr; echo $LocationErr; ?> </span>
                                </div>
                            ...
                            <div class="footer-nav">
                                <nav>
                                    <ul>
                                        ...
                                        <li>
                                            <a href="parkingspot.php">ParkingSpot</a>
                                        </li>
...
<?php
//building table insert code

include('conn_db.php');
session_start();

header("Location: parkingspot.php");

if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
	$b_id = mysqli_real_escape_string($obj->conn,$_POST['psid']);
	$location = mysqli_real_escape_string($obj->conn,$_POST['Location']);


		if(isset($_SESSION['user_name_ows'])){

			$username=$_SESSION['user_name_ows'];
		}
	if( ($_POST['psid'] && $_POST['Location'] && $username)!= NULL) {
		$sql="INSERT INTO building(B_Id,Location,username) VALUES ('$b_id', '$location', '$username')";
