                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"> 
                        ...
                        <div class="booking-form-wrapper text-center clearfix">
                            <h3 class="join-heading">Parking Spot</h3>
                            ...
                            <form action="parkingspot.php" method="POST">
                            ...
                            <form class="booking-form" name="registration"> 
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="PS_Id" class="form-control" placeholder="PS_Id" type="text" name="PS_Id">
                                    <span class="errorcolor"><?php global $PS_IdErr; echo $PS_IdErr; ?> </span>
                                </div>
                                <div class="form-group col-md-6">
								
                                    <input id="Spot NO" class="form-control" placeholder="Spot No" type="text" name="Spot No">
                                    <span class="errorcolor"><?php global $SpotNOErr; echo $SpotNOErr; ?> </span>
                                </div>
                                 
                               <div class="form-group col-md-6">
                                
                                    <input id="Price/Hour" class="form-control" placeholder="Price/Hour" type="text" name="Price/Hour">
                                    <span class="errorcolor"><?php global $Price/HourErr; echo $Price/HourErr; ?> </span>
                                </div>
								
                                <div class="form-group col-md-6">
                                
                                    <input id="your Size" class="form-control" placeholder="Size" type="Size" name="Size">
                                    <span class="errorcolor"><?php global $SizeErr; echo $Sizerr; ?> </span>
                                </div>
